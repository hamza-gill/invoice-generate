                    ...
                    <div class="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
                        ...
                        <div class="mt-6 pt-6 border-t border-gray-100">
                            <label class="flex items-center space-x-3 cursor-pointer">
                                <input type="checkbox" name="auto_send_email" value="1" {{ old('auto_send_email', true) ? 'checked' : '' }} class="w-5 h-5 text-blue-600 border-gray-300 rounded focus:ring-blue-500">
                                <div>
            ...
            <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200 bg-gray-50">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-400">Shows the first invoice this schedule would generate — nothing has been saved yet</p>
                    </div>
                </div>
